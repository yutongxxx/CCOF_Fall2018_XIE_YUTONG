...
//  vidShift.draw(0,0, ofGetWidth(), ofGetHeight());
    ...
    videos[1].draw(0,0,1080,720);
    
    if(byteData < 10 && byteData != 0){
        videos[0].draw(0,0,1080,720);
    }
